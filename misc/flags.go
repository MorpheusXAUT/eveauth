...
var (
	...
	eveSSOClientSecretFlag = flag.String("ssosecret", "", "Client secret used for authenticating with the EVE SSO backend")
	eveSSOCallbackURLFlag  = flag.String("ssocallback", "", "Callback URL provided to the EVE SSO backend")
...
func ParseCommandlineFlags() *Configuration {
	config := &Configuration{
		...
		EVESSOClientSecret: *eveSSOClientSecretFlag,
		EVESSOCallbackURL:  *eveSSOCallbackURLFlag,
	}
